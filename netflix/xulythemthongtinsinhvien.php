...
$sql = "INSERT INTO `sinh_vien`(`ma_sv`, `tensv`, `gioi_tinh`, `ngay_sinh`, `dia_chi`, `sdt`, `ma_lop`, `ma_khoa`, `username`, `password`, `image_path`)
            VALUES ('$maSinhVien','$tenSinhVien','$gioiTinh','$ngaySinh','$diaChi','$soDienThoai',1,1,'$tenDangNhap','$matKhau', '$image_path')";
